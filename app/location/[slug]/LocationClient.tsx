  ...
  <div className="container mx-auto px-6">
    <div className="max-w-4xl">
      <motion.div 
        ...
        className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-blue-500/10 text-blue-600 dark:text-blue-400 text-[10px] font-black uppercase tracking-widest mb-8 border border-blue-500/20 shadow-sm"
      >
        <Star size={12} className="fill-current text-orange-500" />
        Best AC Service in {areaName}, Bareilly
      </motion.div>
      ...
      >
        AC <span className="text-blue-600 italic">Service</span> <br />
      ...
      <p className="text-slate-500 dark:text-slate-400 font-['Hind'] text-xl font-bold leading-relaxed max-w-2xl mb-12">
        Aapke area {areaName} mein sabse fast aur expert AC service. 
        Unique Refrigeration deta hai deep jet cleaning aur gas filling ki suvidha, 
        wo bhi sirf 60 minute ke andar.
      </p>

      {/* ... Buttons wahi rahenge ... */}
    </div>
  </div>
</section>
      {/* --- BENEFITS SECTION --- */}
