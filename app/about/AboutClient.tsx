    ...
    <main className="bg-[var(--background)] min-h-screen transition-colors duration-500">
      ...
      <section className="pt-32 pb-20 relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 text-center">
          ...
          >
            <Award size={14} /> Top-Rated AC Service in Bareilly
          </motion.div>
        ...
        <div className="container mx-auto px-6 relative z-10 grid lg:grid-cols-2 gap-16 items-center">
          <div className="space-y-8">
            <h2 className="text-4xl md:text-6xl font-black tracking-tighter uppercase italic leading-none">
              A Journey of <br /><span className="text-blue-400">Excellence in Bareilly.</span>
            </h2>
            ...
            <div className="flex gap-6">
              <div className="flex items-center gap-2">
                ...
                <span className="font-black uppercase tracking-widest text-xs">#1 Repair Service in Bareilly</span>
              </div>
            </div>
          </div>
          ...
          <div className="relative h-[400px] rounded-[3rem] overflow-hidden border-4 border-white/10 shadow-2xl">
            <Image 
              src="/images/gl-5.jpg" 
              alt="Unique Refrigeration Bareilly Workshop"
              fill
      ...
      <section className="py-24">
        <div className="container mx-auto px-6 text-center mb-16">
          <h2 className="text-4xl font-black uppercase tracking-tighter text-[var(--foreground)]">Why Bareilly Trusts Us</h2>
        </div>
